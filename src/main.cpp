...
const int BRAKE_DEPRESSED_THRESHOLD = 512;  
...
const unsigned long APPS_FAULT_TIMEOUT = 100;  // 100ms fault duration
...
void setup() {
  ...
  pinMode(START_BUTTON_PIN, INPUT_PULLUP);  // Assuming active-low button; adjust if needed
